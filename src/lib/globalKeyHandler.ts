...
const ACTION_SCOPES: Record<string, KeybindingScope> = {
  ...
  // 编辑器快捷键
  'note.save': KeybindingScope.Editor,
  'note.find': KeybindingScope.Editor,
  'note.closeTab': KeybindingScope.Editor,
  'note.togglePreview': KeybindingScope.Editor,
  'note.zoomIn': KeybindingScope.Editor,
  'note.zoomOut': KeybindingScope.Editor,
  'note.zoomReset': KeybindingScope.Editor,
};
